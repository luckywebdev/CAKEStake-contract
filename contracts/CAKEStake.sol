...
// SPDX-License-Identifier: MIT 
 ...
 /*   CAKEStake - investment platform based on Binance Smart Chain blockchain smart-contract technology. Safe and legit!
 ...
 *    /  _ \   |  |  | | / /|  __ |/ ___|_| |_    | |
 *    | | |_|  /  \  | |/ / | |_ \| /__ |_   _|_ _| | _ __       CAKEStake.app
 *    | |  _  / /\ \ |   (  |  _|  `--..`\| |/ _` | |/ / _ \     by AV
 *    | |_| |/ /--\ \| |\ \ | |__/|/\__/ /| | (_| |   <  __/
 *    \____/__/    \_|_| \_\|_____|\____/ \__\__,_|_|\_\___|
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://cakestake.app                                       │
 *   │                                                                       │
 *   │   Telegram Live Support: @cakestake_support                            |
 *   │   Telegram Public Group: https://t.me/cake_stake                       |
 *   |                                                                       |
 *   |   E-mail: admin@cakestake.app                                          |
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 *   2) Choose one of the tariff plans, enter the CAKE amount (0.05 CAKE minimum) using our website "Stake CAKE" button
 ...
 *   - Minimal deposit: 0.05 CAKE, no maximal limit
...
contract CAKEStake {
	...
	constructor(address payable wallet, uint256 startDate, ICakeToken token) public {
	...
	function invest(address referrer, uint8 plan, uint256 investAmount) public {
		require(investAmount >= INVEST_MIN_AMOUNT, "Invest amount is very low than MIN AMOUNT");
        require(plan < 6, "Invalid plan");

		uint256 fee = investAmount.mul(PROJECT_FEE).div(PERCENTS_DIVIDER);
		_cakeToken.transfer(commissionWallet, fee);
		...
		_cakeToken.approve(msg.sender, investAmount);
...
// 		msg.sender.transfer(totalAmount);
        _cakeToken.transfer(msg.sender, totalAmount);
